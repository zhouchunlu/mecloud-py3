...
from mecloud.helper.FollowHelper import FollowHelper
from mecloud.helper.Util import MeEncoder
from mecloud.lib import log
from mecloud.model.MeError import ERR_NOPARA, ERR_PATH_PERMISSION, ERR_SUCCESS, ERR_INVALID, ERR_USER_NOTFOUND, \
    ERR_BLACKED_PERMISSION, ERR_BEBLACKED_PERMISSION, ERR_DB_OPERATION
...
class FollowerHandler(BaseHandler):
    ...
    def get(self, followType):
        ...
        try:
            ...
            is_user = True
            skipNum = 0
            if 'lastTime' in self.request.arguments:
